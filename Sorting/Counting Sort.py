...
>> Create a array name count with len = max element + 1, initialized with 0 at all indices
>> Loop thro the input array and store the frequence in the count array, use element as the index to access the count array
